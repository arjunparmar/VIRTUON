...
def gpm_segment(txt_file = './model/input/test/test_pairs.txt', classes = 20, hidden_graph_layers=256, resume_model = './model/grapy/data/models/CIHP_trained.pth', dataset = 'cihp', batch = 1, output_path = './model/input/test/test/', cloth = False):
