...
def train_tom(train_loader, model, board, lr = 0.0001, betas=(0.5, 0.999), keepstep = 1e5, decaystep=1e5, display_count = 100, save_count = 1000, name = 'TOM', checkpoint_dir = ""):
    model.cuda()
    model.train()
    ...
    scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=lambda step: 1.0 -
                                                  max(0, step - keepstep) / float(decaystep + 1))
