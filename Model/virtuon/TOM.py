...
def test_tom(test_loader, model, checkpoint=os.path.abspath('virtuon/PreTrainedModels'), result_dir=os.path.abspath('output'), name="TOM", model_name = 'PreTrainedTOM',
             display_count=100):
